# Mensajes de WhatsApp para invitar a nuevos ponentes
...
## Versión 1 · Nutrición clínica — 4 temas a elegir

> Para nutricionistas clínicos y endocrinólogos con perfil nutricional.

```
Hola [NOMBRE], ¿cómo estás? Te escribe Omidres Pérez, endocrinóloga.

Te contacto por encargo de la Sociedad de Endocrinología y Diabetes
del Austro (SEDA). Estamos organizando un curso virtual de
actualización en obesidad, diabetes, nutrición clínica y salud
digital, en trámite de aval académico ante la Universidad de Cuenca.

Son 7 módulos, 28 clases grabadas, y nos encantaría contar contigo
como docente.
...
## Versión 2 · Salud digital — 3 temas a elegir

> Para informática médica, IA en salud, telemedicina, bioética o derecho sanitario.
...
2. Terapéutica digital, inteligencia artificial y educación
   del paciente
...
## Versión 3 · Tema único

> Para los temas que no admiten elección. Sustituye el bloque entre corchetes por el que corresponda.
...
Son 7 módulos y 28 clases grabadas, dictadas por especialistas de
Ecuador, México y Costa Rica.

Te escribo porque hay un tema que es exactamente lo tuyo:
...
## Versión 4 · Sondeo breve

> Para alguien con quien no tienes confianza todavía, o cuando prefieres tantear antes de invitar formalmente.

```
Hola [NOMBRE], buen día. Te escribe Omidres Pérez, endocrinóloga.

Estoy apoyando a la Sociedad de Endocrinología y Diabetes del
Austro con un curso virtual de obesidad, diabetes y nutrición
